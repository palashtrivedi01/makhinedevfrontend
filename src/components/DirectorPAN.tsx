...
const DirectorPAN: React.FC = () => {
  ...
  return (
    <div className="w-full min-h-screen flex justify-center items-center p-6">
      <div className="flex flex-col md:flex-row border border-gray-300 bg-white overflow-hidden max-w-5xl w-full pb-8">
        {/* Left Section */}
    ...
    {isValid && (
      <>
        ...
        <Button onClick={() => alert("Proceeding...")} label="Continue" />
      </>
    )}
